...
for (const phrase of ["controlled_runtime", "new_analysis", "Evidence drawer", "Execution timeline", "unusual service/window ranking", "Save / export", "datetime-local", "Window start (UTC)", "+00:00", "window_start", "createObjectURL", "Withhold source · unavailable (Phase 4)", "suggestions only"]) {
